      ...
      if (currentUser != null) {
        ...
        if (userSnapshot.exists) {
          ...
          setState(() {
            ...
            _selectedServiceController.text = userData['Selected_Service'] ?? ''; // Correctly update controller
    ...
    try {
      ...
      if (currentUser != null) {
        await _firestore.collection('User').doc(currentUser.uid).update({
          ...
          'Selected_Service': _selectedServiceController.text.trim(),  // Save the selected service
        });
        ScaffoldMessenger.of(context).showSnackBar(
